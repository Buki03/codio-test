...
sys.path.append('../codio-test') # imports python file from parent directory
...
class UsersTests(unittest.TestCase):
    ...
    def test_valid_user_registration(self):
        ...
        response = self.register('second_test', 'second@example.com', 'TestIsAwesome')
        self.assertEqual(response.status_code, 200)
    ...
    def test_invalid_username_registration(self):
        ...
        response = self.register('1', 'test@example.com', 'FlaskIsAwesome')
        self.assertIn(b'Field must be between 2 and 20 characters long.', response.data)
    ...
    def test_invalid_email_registration(self):
        ...
        response = self.register('test2', 'test@ex', 'FlaskIsAwesome')
        self.assertIn(b'Invalid email address.', response.data)
